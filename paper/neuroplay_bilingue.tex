...
% Título bilíngue
\title{\textbf{NeuroPlay: Uma Plataforma Web Adaptativa para Treinamento de Funções Executivas em Indivíduos com Transtorno do Espectro Autista}\\[0.5cm]
\large\textbf{NeuroPlay: A Web-Based Adaptive Platform for Executive Function Training in Individuals with Autism Spectrum Disorder}}
...
\textbf{Objetivo:} Este artigo apresenta o NeuroPlay, uma plataforma web projetada para treinar funções executivas em indivíduos com TEA através de jogos terapêuticos gamificados e adaptativos.

\textbf{Métodos:} O NeuroPlay foi desenvolvido utilizando React.js, Three.js e TensorFlow.js. A plataforma implementa três jogos principais: (1) Dual N-Back para memória de trabalho, (2) Caçador de Alvos para controle inibitório, e (3) Mestre do Sinal para flexibilidade cognitiva. O design seguiu os padrões WCAG 2.1 AA e diretrizes de neurodiversidade.

\textbf{Resultados:} A plataforma integra algoritmos adaptativos de IA que ajustam a dificuldade em tempo real. O sistema alcança compatibilidade multiplataforma, customização sensorial e rastreamento de progresso. Testes simulados (N=100) demonstraram 89\% dos usuários na zona alvo de dificuldade (70-80\% acurácia).

\textbf{Conclusões:} O NeuroPlay representa uma solução escalável e acessível para treinamento de FE em TEA. Trabalhos futuros incluirão validação clínica, módulos de cognição social e integração biométrica.

\textbf{Palavras-chave:} Transtorno do Espectro Autista; Funções Executivas; Gamificação; Aprendizado Adaptativo; Intervenção Digital; Neurodiversidade; Acessibilidade
\end{abstract}
...
\textbf{Objective:} This paper presents NeuroPlay, a web-based platform designed to train executive functions in individuals with ASD through gamified, adaptive therapeutic games.

\textbf{Methods:} NeuroPlay was developed using React.js, Three.js, and TensorFlow.js. The platform implements three core games: (1) Dual N-Back for working memory, (2) Target Hunter for inhibitory control, and (3) Simon Says for cognitive flexibility. Design followed WCAG 2.1 AA standards and neurodiversity guidelines.

\textbf{Results:} The platform integrates adaptive AI algorithms that adjust task difficulty in real-time. The system achieves cross-platform compatibility, sensory customization, and comprehensive progress tracking. Simulated testing (N=100) demonstrated 89\% of users maintained in target difficulty zone (70-80\% accuracy).

\textbf{Conclusions:} NeuroPlay represents a scalable, accessible solution for EF training in ASD populations. Future work will include clinical validation, social cognition modules, and biometric integration.

\textbf{Keywords:} Autism Spectrum Disorder; Executive Functions; Gamification; Adaptive Learning; Digital Intervention; Neurodiversity; Accessibility
\end{abstract}
